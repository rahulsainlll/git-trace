...
import Pagination from '@/components/pagination'; // Adjust the import path if necessary
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans mb-10">
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 text-center"> {/* Added text-center */}
          <h1 className="text-5xl font-bold mb-4" style={{ fontFamily: 'Marker Felt, fantasy', color: '#eec0c8' }}>
            Welcome to the Blog
          </h1>
          <p className="text-xl text-gray-600"> {/* Increased font size */}
      ...
      <section className="container mx-auto py-10 px-6 flex flex-col justify-center">
        <h2 
          ...
          style={{ fontFamily: 'Marker Felt, fantasy', color: '#00BFFF' }} // This is the hex code for a cyan blue color
        >
          Latest Posts
        </h2>
